...
#     x = layers.LSTM(150)(inp)
#     x = x[:, :, None]
#     x = layers.Conv1D(4, 5, activation='leaky_relu')(x)
#     x = layers.Conv1D(8, 5, activation='leaky_relu')(x)
#     # x = layers.BatchNormalization()(x)
#     x = layers.Conv1D(16, 5, activation='leaky_relu')(x)
#     x = layers.Conv1D(32, 5, activation='leaky_relu')(x)
#     # x = layers.BatchNormalization()(x)
#     x = layers.Conv1D(64, 5, activation='leaky_relu')(x)
#     x = layers.Conv1D(128, 5, activation='leaky_relu')(x)
#     x = layers.Conv1D(256, 5, activation='leaky_relu')(x)
#     x1 = layers.GlobalAveragePooling1D()(x)
#     x2 = layers.GlobalMaxPool1D()(x)
#     x = tf.concat([x1, x2], axis=-1)
